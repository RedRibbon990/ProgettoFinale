...
__webpack_require__(/*! ../../resources/css/app.css */ "./resources/css/app.css"); // Utilizza le barre oblique (/) nei percorsi
...
function applyHomepageStyle() {
  // Remove navbar
  var navElement = document.querySelector('.Home');
  if (window.location.pathname === '/') {
    if (navElement) {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#switch").on("click", function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullpage").hasClass("night")) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullpage").removeClass("night");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#switch").removeClass("switched");
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullpage").addClass("night");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpp"] = self["webpackChunkpp"] || [];
